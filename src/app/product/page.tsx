...
//       // while (formData[`spec_${specIndex}_name`]) {
//       //   specs.push({
//       //     specName: formData[`spec_${specIndex}_name`],
//       //     specDescription: formData[`spec_${specIndex}_description`] || '',
//       //     dataType: formData[`spec_${specIndex}_dataType`] || 'TEXT',
//       //     specValue: formData[`spec_${specIndex}_value`],
//       //     isActive: formData[`spec_${specIndex}_isActive`] !== false
//       //   });
//       //   specIndex++;
//       // }
